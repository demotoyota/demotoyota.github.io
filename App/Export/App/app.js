...
app.service('IndexServices', function ($http, AppConfig) {
    ...
    this.SentMailHoTroTaiChinh = function (ids, fullname, semail, stenxe, stienxe, smauxe, stienphukien, stientratruoc, stiendautien, stientindung, supportProduct, sgoclaicuoiki, idDlr, sLinkdownload) {
        return $http({
            method: "POST",
            url: AppConfig.Api_Server +
                "/Tools/SentMailHoTroTaiChinh?Ids=" + ids + "&fullname=" + fullname + "&email=" + semail + "&tenxe=" + stenxe + "&tienxe=" + stienxe + "&mauxe=" + smauxe + "&tienphukien=" + stienphukien + "&tientratruoc=" + stientratruoc + "&tiendautien=" + stiendautien + "&tientindung=" + stientindung + "&supportProduct=" + supportProduct + "&goclaicuoiki=" + sgoclaicuoiki + "&sLinkdownload=" + sLinkdownload + "&iDealer=" + idDlr
        });
    }
    ...
    this.SentMailDuToanChiPhi = function (ids, fullname, email, tenxe, tienxe, mauxe, thongtintruocba, phukien, tongtien, idDlr) {
        //console.log(thongtintruocba);
        return $http({
            method: "POST",
            url: AppConfig.Api_Server +
                "/Tools/SentMailDuToanChiPhi?Ids=" + ids + "&fullname=" + fullname + "&email=" + email + "&tenxe=" + tenxe + "&tienxe=" + tienxe + "&mauxe=" + mauxe + "&thongtintruocba=" + thongtintruocba + "&phukien=" + phukien + "&tongtien=" + tongtien + "&iDealer=" + idDlr
        });
    }
    ...
    this.postContactDetailProductOldMain = function (name, email, phone, address, content, carname, carid, idDlr, branchId) {
        return $http({
            method: "POST",
            url: AppConfig.Api_Server +
                "/ContactMain/PostContactInDetailOldCar?sNameCar=" + carname + "&sFullName=" + name + "&sEmail=" + email + "&sPhone=" + phone + "&sContent=" + content + "&iDealer=" + idDlr + "&iBranch=" + branchId
        });
    }
    ...
    //đăng ký lái thử
    this.postTestDrive = function (arrId, titleName, fName, lName, email, phone, date, time, note, adrress, iDlr) {
        return $http({
            method: "POST",
            url: AppConfig.Api_Server +
                "/Tools/PostContactTestDrive?modelid=" + arrId + "&sName=" + titleName + "&sFName=" + lName + "&sLName=" + fName + "&sEmail=" + email + "&sPhone=" + phone + "&sDate=" + date + "&sTime=" + time + "&sNote=" + note + "&sAdrress=" + adrress + "&iDealer=" + iDlr
        });
    }
    this.postTestDriveMain = function (arrId, titleName, fName, lName, email, phone, date, time, note, adrress, iDlr) {
        return $http({
            method: "POST",
            url: AppConfig.Api_Server +
                "/ToolsMain/PostContactTestDrive?modelid=" + arrId + "&sName=" + titleName + "&sFName=" + lName + "&sLName=" + fName + "&sEmail=" + email + "&sPhone=" + phone + "&sDate=" + date + "&sTime=" + time + "&sNote=" + note + "&sAdrress=" + adrress + "&iDealer=" + iDlr
        });
    }
    this.postServiceRegister = function (arrId, titleName, fName, lName, email, phone, date, date2, time, time2, note, license, modelcar, typecar, yearcar, adrress, employer, idDlr) {
    ...
    this.postServiceRegisterMain = function (arrId, titleName, fName, lName, email, phone, date, date2, time, time2, note, license, modelcar, typecar, yearcar, adrress, employer, idDlr) {
        //console.log(AppConfig.Api_Server + "/Tools/PostContactService/?sTitle=" + arrId + "&sName=" + titleName + "&sFName=" + lName + "&sLName=" + fName + "&sEmail=" + email + "&sPhone=" + phone + "&sDate=" + date + "&sDate2=" + date2 + "&sTime=" + time + "&sTime2=" + time2 + "&sNote=" + note + "&sCarLP=" + license + "&sCarModel=" + modelcar + "&stypeCar=" + typecar + "&sCarYear=" + yearcar + "&sAddress=" + adrress + "&sEmployer=" + employer + "&iDealer=" + idDlr);
        var param = {
            sTitle: arrId,
            sName: titleName,
        ...
        return $http({
            ...
            //    "&sTime=" + time + "&sTime2=" + time2 + "&sNote=" + note + "&sCarLP=" + license + "&sCarModel=" + modelcar + "&stypeCar=" + typecar +
            //    "&sCarYear=" + yearcar + "&sAddress=" + adrress + "&sEmployer=" + employer + "&iDealer=" + idDlr
            url: AppConfig.Api_Server + "/ToolsMain/PostContactService",
            params: param
        });
    }
...
app.run(['$rootScope', '$location', 'IndexServices', '$sce', '$filter', '$route', 'MessageConfig',
    function ($rootScope, $location, services, $sce, $filter, $route, message) {
        ...
        $rootScope.processToSearch = function () {
            var key = $(".inSearchTextBox").val().toLowerCase();
        ...
        $rootScope.SentMailHoTroTaiChinh = function (ids, fullname, semail, stenxe, stienxe, smauxe, stienphukien, stientratruoc, stiendautien, stientindung, supportProduct, sgoclaicuoiki, idDlr, sLinkdownload) {
            services.SentMailHoTroTaiChinh(ids, fullname, semail, stenxe, stienxe, smauxe, stienphukien, stientratruoc, stiendautien, stientindung, supportProduct, sgoclaicuoiki, idDlr, sLinkdownload);
        ...
        $rootScope.SentMailDuToanChiPhi = function (ids, fullname, email, tenxe, tienxe, mauxe, thongtintruocba, phukien, tongtien, idDlr) {
            services.SentMailDuToanChiPhi(ids, fullname, email, tenxe, tienxe, mauxe, thongtintruocba, phukien, tongtien, idDlr);
            $(".fancybox-close-small").click();
            //$.fancybox.close(all);
        ...
        $rootScope.PostContactDetailProductOldMain = function (name, email, phone, address, content, carname, carid, idDlr, branchId) {
            services.postContactDetailProductOldMain(name, email, phone, address, content, carname, carid, idDlr, branchId);
            showSuccessbyAlert('Liên hệ', message.message2, "");
            $(".fancybox-close-small").click();
        }

        $rootScope.PostTestDrive = function (arrId, titleName, fName, lName, email, phone, date, time, note, adrress, iDlr) {
            services.postTestDrive(arrId, titleName, fName, lName, email, phone, date, time, note, adrress, iDlr);
        ...
        $rootScope.PostTestDriveMain = function (arrId, titleName, fName, lName, email, phone, date, time, note, adrress, iDlr) {
            services.postTestDriveMain(arrId, titleName, fName, lName, email, phone, date, time, note, adrress, iDlr);
            $(".testdrive_tabs .complete").addClass("notclick");
            //if (email.length > 3) {
            //    showSuccessbyAlert('Đăng ký lái thử', message.message2, "");
            //}
        ...
        $rootScope.PostRegisterService = function (arrId, titleName, fName, lName, email, phone, date, date2, time, time2, note, license, modelcar, typecar, yearcar, adrress, employer, idDlr) {
            services.postServiceRegister(arrId, titleName, fName, lName, email, phone, date, date2, time, time2, note, license, modelcar, typecar, yearcar, adrress, employer, idDlr);
            //console.log(arrId);
        ...
        $rootScope.PostRegisterServiceMain = function (arrId, titleName, fName, lName, email, phone, date, date2, time, time2, note, license, modelcar, typecar, yearcar, adrress, employer, idDlr) {
            services.postServiceRegisterMain(arrId, titleName, fName, lName, email, phone, date, date2, time, time2, note, license, modelcar, typecar, yearcar, adrress, employer, idDlr);
            //console.log(arrId);
            $(".dangkydichvu_tabs .complete").addClass("notclick");
            //if (email.length > 3) {
            //    showSuccessbyAlert('Đăng ký dịch vụ', "<p>Xin cảm ơn!</p><p>Chúng tôi sẽ liên hệ Quí khách trong thời gian sớm nhất.</p>", "");
        ...
        success: function (data) {
            ...
            if (countList > 0) {
                for (var j = 0; j < countList; j++) {
                    var pricefrom = "Giá:";
                    if (data.lModels[j].newS_TITLE.indexOf("Camry") !== -1) {
                        pricefrom = "Giá từ:";
                    }
                    ...
                    str += '' +
                        ...
                        '</span>' +
                        //price
                        '<span class="price">' + pricefrom +
                        ' <span>' + mon + '</span> <sup>' + money + '</sup>' +
                        '</span>' +
                        '</span>' +
                        '</span>' +
                ...
                for (var c = 0; c < selectCar.length; c++) {
                    var pricefrom = "Giá:";
                    if (selectCar[c].name.indexOf("Camry") !== -1) {
                        pricefrom = "Giá từ:";
                    }
                    ...
                    str += '' +
                        ...
                        //price
                        '<span class="price">' + pricefrom +
                        ' <span>' + selectCar[c].price + +'</span> <sup>' + money + '</sup>' +
                        '</span>' +
                        '</span>' +
                        '</span>' +
                        '</label>' +
                ...
                for (var ci = 0; ci < selectCar.length; ci++) {
                    ...
                    str += '' +
                        ...
                        //price
                        '<span class="price">' + pricefrom +
                        ' <span>' + selectCar[ci].price + +'</span> <sup>' + money + '</sup>' +
                        '</span>' +
                        '</span>' +
                        '</span>' +
                        '</label>' +
